...
def close_add_log_screen():
    xl.save_wb()  # saves data in Excel
...
def open_existing_workbook():
    ...
    Button(open_wb_screen, text = "OK", command = close_open_wb_screen).pack()
...
def add_another_log():
    # prompt user to enter another Date, Location, Amount
    # retrieve user data
    # go to Excel file
    # search for an empty row
    # add data in empty row
    pass
